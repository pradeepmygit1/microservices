...
public class CusromerController {
   ...
   private  static final Logger logger = LoggerFactory.getLogger(CusromerController.class);
   private final ICutomersService iCutomersService;
    ...
    public ResponseEntity<CustomerDetailsDto> fetchCustomerDetails(@RequestHeader("eazybank-correlation-id") String correlationId,
        ...
        CustomerDetailsDto customerDetailsDto = iCutomersService.fetchCustomerDetails(mobileNumber,correlationId);
