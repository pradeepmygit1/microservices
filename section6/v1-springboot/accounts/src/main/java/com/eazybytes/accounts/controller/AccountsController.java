...
import com.eazybytes.accounts.dto.AccountsCotactInfoDto;
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "Get Java versions that is installed into accounts microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
